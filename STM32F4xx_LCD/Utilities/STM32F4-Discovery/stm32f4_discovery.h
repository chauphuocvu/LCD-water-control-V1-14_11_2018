...
/** @addtogroup STM32F4_DISCOVERY_LOW_LEVEL_LED
  * @{
  */
//user change this from discovery (3 LED: LED4, LED3, LED5)
#define LEDn                                4
//PB9 TouchPanel nCS
#define TP_CS_PIN                           GPIO_Pin_9
#define TP_CS_GPIO_PORT                     GPIOB
#define TP_CS_GPIO_CLK                      RCC_AHB1Periph_GPIOB  
...
#define BZ_GPIO_CLK                         RCC_AHB1Periph_GPIOC 

//PD13 Backlight control
#define BL_PIN                              GPIO_Pin_13
#define BL_GPIO_PORT                        GPIOD
#define BL_GPIO_CLK                         RCC_AHB1Periph_GPIOD 
