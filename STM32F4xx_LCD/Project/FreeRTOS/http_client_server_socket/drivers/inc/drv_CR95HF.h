...
#define CR95HF_SPI_SCK_PIN        	GPIO_Pin_10
#define CR95HF_SPI_SCK_GPIO_PORT   	GPIOC
#define CR95HF_SPI_SCK_GPIO_CLK    	RCC_AHB1Periph_GPIOC
 
#define CR95HF_SPI_MISO_PIN        	GPIO_Pin_11
#define CR95HF_SPI_MISO_GPIO_PORT  	GPIOC
#define CR95HF_SPI_MISO_GPIO_CLK   	RCC_AHB1Periph_GPIOC
 
#define CR95HF_SPI_MOSI_PIN        	GPIO_Pin_12
#define CR95HF_SPI_MOSI_GPIO_PORT  	GPIOC
#define CR95HF_SPI_MOSI_GPIO_CLK   	RCC_AHB1Periph_GPIOC

#define CR95HF_NCS_PIN             	GPIO_Pin_13
#define CR95HF_NCS_GPIO_PORT       	GPIOC
#define CR95HF_NCS_GPIO_CLK        	RCC_AHB1Periph_GPIOC
...
/** 
  ...
  */ 
#define CR95HF_UART			        		USART1
#define CR95HF_UART_CLK		        	RCC_APB2Periph_USART1

#define CR95HF_UART_TX_PIN         	GPIO_Pin_9
#define CR95HF_UART_TX_GPIO_PORT   	GPIOA                       
#define CR95HF_UART_TX_GPIO_CLK    	RCC_AHB1Periph_GPIOA
 
#define CR95HF_UART_RX_PIN        	GPIO_Pin_10                
#define CR95HF_UART_RX_GPIO_PORT  	GPIOA                       
#define CR95HF_UART_RX_GPIO_CLK   	RCC_AHB1Periph_GPIOA

#define CR95HF_IRQin_PIN        		GPIO_Pin_9                 
#define CR95HF_IRQin_GPIO_PORT  		GPIOA                       
#define CR95HF_IRQin_GPIO_CLK   		RCC_AHB1Periph_GPIOA
