...
/** @defgroup TscHal_Private_Defines
  * @{
  */
#if (defined(USE_STM3210C_EVAL) || defined(USE_STM32100E_EVAL) || defined(USE_STM322xG_EVAL) || defined(USE_STM32F4_BRD))
...
/* SPI2 define for TouchScreen Controller 2046 */
...
#define	CHX 	0x90 	/* Channel X */	
#define	CHY 	0xd0	/* Channel Y */
#define	REFOFF 	0x82	/*  */
