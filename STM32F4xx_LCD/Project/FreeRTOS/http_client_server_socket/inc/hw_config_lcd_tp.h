...
#ifndef __HARDWARE_CONFIG_LCD_TP_H
#define __HARDWARE_CONFIG_LCD_TP_H
...
#else
	/*SPI interface define STM32F4 use 2046 touchscreen controller*/
...
#endif /* __HARDWARE_CONFIG_LCD_TP_H */
